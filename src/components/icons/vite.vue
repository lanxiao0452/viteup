<template>
  <svg viewBox="0 0 48 46" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill="#863BFF"
      style="fill: #863bff; fill: color(display-p3 0.5252 0.23 1); fill-opacity: 1"
    />
    <mask
      id="mask0_2002_17158"
    ...
    <g mask="url(#mask0_2002_17158)">
      <g filter="url(#filter0_f_2002_17158)">
        <ellipse
          ...
          fill="#EDE6FF"
          style="fill: #ede6ff; fill: color(display-p3 0.9275 0.9033 1); fill-opacity: 1"
        />
      </g>
      ...
      <g filter="url(#filter2_f_2002_17158)">
        <ellipse
          ...
          fill="#7E14FF"
          style="fill: #7e14ff; fill: color(display-p3 0.4922 0.0767 1); fill-opacity: 1"
        />
      </g>
      ...
      <g filter="url(#filter10_f_2002_17158)">
        <ellipse
          ...
          fill="#47BFFF"
          style="fill: #47bfff; fill: color(display-p3 0.2799 0.748 1); fill-opacity: 1"
        />
      </g>
